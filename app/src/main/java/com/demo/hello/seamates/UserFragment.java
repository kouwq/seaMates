...
public class UserFragment extends Fragment implements Runnable {
    ...
    private TextView name, account, sex, phone, major, info;
    private String nameText, accountText, sexText, phoneText, majorText, infoText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //获取登陆页面传参
        String sourceText = getActivity().getIntent().getStringExtra("source");
        if ("login".equals(sourceText)) {
            ...
            accountText = sharedPreferences.getString("account", "");
            nameText = sharedPreferences.getString("name", "");
            sexText = sharedPreferences.getString("sex", "");
            phoneText = sharedPreferences.getString("phone", "");
            majorText = sharedPreferences.getString("major", "");
